...
namespace ZJVL
{
	...
	void GameScene::sort_entities(std::vector<Entity> &to_sort)
	{
	...
	void GameScene::merge(std::vector<Entity> &l_vect, std::vector<Entity> &r_vect, std::vector<Entity> &merged)
	{
	...
	void GameScene::draw_entity(Entity &entity)
	{
